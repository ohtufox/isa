...
function checkTarget(target, listener) {
    ...
    console.log('checktargetiin saatu target: ' + target);
...
StreamListener.prototype = {
    ...
    onStopRequest: function(aRequest, aContext, aStatus) {
        ...
        if (components.isSuccessCode(aStatus)) {
            ...
            console.log("these are the stored values: " + this.requestURI + " ");
            this.mCallbackFunc(state, this.requestURI);
            console.log("callback finished");
        } else {
            this.mCallbackFunc("TARGET_UNDETERMINED", this.requestURI);
        }
