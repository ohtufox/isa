...
function checkTarget(url) {
   ...
   console.log("is this a httpchannel: " +gChannel);
   console.log("does it have an httpchannel attribute: " +gChannel.requestMethod);
...
function checkSecurity() {
   ...
   let request = gChannel.QueryInterface(Ci.nsIRequest); 
