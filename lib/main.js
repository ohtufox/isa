...
gBrowser.addEventListener("onSecurityChange", function(aWebProgress, aRequest, aState) { listener.myListener.onSecurityChange(aWebProgress, aRequest, aState); }, true);
